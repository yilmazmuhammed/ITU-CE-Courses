...
def add_person(first_name, last_name, birth_year):
    global people
    people += [(first_name, last_name, birth_year)]
...
def find_person(first_name, last_name):
    ...
    for i in range(len(people)):
        if people[i][0] == first_name and people[i][1] == last_name:
            person_no = i
            break
    return person_no
...
def print_person(person_no):
    ...
    if person_no == -1:
        ...
        print('---------------------')
        print('Name: ' + people[person_no][0] + ' ' + people[person_no][1])
        print('Birth year: ' + str(people[person_no][2]))
...
def update_first_name(first_name, last_name, new_value):
    ...
    if person_no == -1:
        ...
        new_first_name = new_value
        old_last_name = people[person_no][1]
        old_birth_year = people[person_no][2]
        people[person_no] = (new_first_name, old_last_name, old_birth_year)
...
def update_last_name(first_name, last_name, new_value):
    ...
    if person_no == -1:
        ...
        old_first_name = people[person_no][0]
        new_last_name = new_value
        old_birth_year = people[person_no][2]
        people[person_no] = (old_first_name, new_last_name, old_birth_year)
...
def update_birth_year(first_name, last_name, new_value):
    ...
    if person_no == -1:
        ...
        old_first_name = people[person_no][0]
        old_last_name = people[person_no][1]
        new_birth_year = new_value
        people[person_no] = (old_first_name, old_last_name, new_birth_year)
